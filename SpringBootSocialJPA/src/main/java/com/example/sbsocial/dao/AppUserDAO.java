package com.example.sbsocial.dao;

import com.example.sbsocial.entity.AppRole;
import com.example.sbsocial.entity.AppUser;
import com.example.sbsocial.form.AppUserForm;
import com.example.sbsocial.utils.EncryptedPasswordUtils;
...
public class AppUserDAO {
    ...
    public AppUser createAppUser(Connection<?> connection) {
        ...
        String encrytedPassword = EncryptedPasswordUtils.encryptedPassword(randomPassword);
        //
        appUser = new AppUser();
    ...
    public AppUser registerNewUserAccount(AppUserForm appUserForm, List<String> roleNames) {
        ...
        appUser.setEnabled(true);
        String encryptedPassword = EncryptedPasswordUtils.encryptedPassword(appUserForm.getPassword());
